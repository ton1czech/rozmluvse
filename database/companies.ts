export const companies = [
  {
    ...
    textDe:
      '"Wir sind froh, dass wir in Rozmluv se einen Partner haben, der uns in dem voranbringt, was für uns Journalisten das Wichtigste ist, nämlich in der Kommunikation."',
    textUa:
  ...
  },
  {
    ...
    textDe:
      '"Falls Sie noch zögern, greifen Sie zu. Mit diesem Sprachstudio kommt wirklich jeder in die Gänge. Sie haben uns voran gebracht, sie werden das auch bei Ihnen schaffen."',
    textUa:
